...
const rows = [
  ...
  },
  {
    ...
    plannedEvidence: [
      ...
      "installed Intrepid persistent Codex secondary -> ordinary Cursor -> persistent Codex secondary switch-and-return",
...
const executionContracts = {
  ...
  "ZED-ACP-SWITCH-005": {
    commands: [
      ...
      "computer-use installed Zed 10x in an Intrepid project: switch Codex (Intrepid, secondary) -> Cursor (Intrepid) -> Codex (Intrepid, secondary), require a ready composer after every transition, then close Zed and prove exact attachment cleanup",
    ],
    evidencePaths: [
