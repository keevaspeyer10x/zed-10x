...
/// A user-message ID generated by Zed and passed to agents that support client IDs.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, Hash)]
pub struct ClientUserMessageId(SharedString);
...
mod test_support {
    ...
    struct StubAgentSessionClientUserMessageIds {
        connection: StubAgentConnection,
    }

    impl AgentSessionClientUserMessageIds for StubAgentSessionClientUserMessageIds {
        fn prompt(
            &self,
